...
# Overlapping Image Patch Embedding
...
class Restormer(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        out_dec_level3 = self.up4_3(out_enc_level4)
        inp_dec_level3 = torch.cat([out_dec_level3, out_enc_level3], 1)
        ...
        out_img = self.output(out_dec_level1) + inp_img
        return out_img
